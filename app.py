...
<div class="main-header">
    ...
    <p>Tác giả: Mai Thị Hiệp - Trường Tiểu học Quyết Tiến - ĐT: 0325899811</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Mai Thị Hiệp - Trường Tiểu học Quyết Tiến - ĐT: 0325899811</div>", unsafe_allow_html=True)
